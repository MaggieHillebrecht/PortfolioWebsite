...
For me writing the StartGame function was the hardest because I had to figure out where and how to put all of the pieces together. 
Looking back after over 6 months, I would have organized my code a lot more. I orignially wanted to create inheritance within my work 
but got overwhelmed very quickly as I created all of the classes. I think now that is the biggest change I would do.
With the function below, I found it eaiser when I went to a white board and starting drawing out a finite state machine with all 
of the functions I had coded up until that point.
